def process_gas_consumption(df, environment_type: str, facility_subtype: str, holiday_usage: str, holiday_days: str, duration_months: int, data_handling_method: str, tmp_path: str = None, facility_size: str = ""):
    """
    ...
    if environment_type == 'house':
        ...
        return process_company_gas(df, facility_subtype, facility_size, holiday_usage, holiday_days, duration_months, data_handling_method, tmp_path)
    else:
